  ...
  >
    ...
    <div class="my-8 flex items-center"> 
        ...
        <div class="flex items-center mr-5">
          <label class="custom-check-box mr-4">Payée
            <input type="checkbox" wire:click="payeeClicked" wire:model="payee" value="payee" id="payee">
            <span class="checkmark"></span>
          </label>
          <label class="custom-check-box">Non Payée
            <input type="checkbox" wire:click="nonPayeeClicked" wire:model="nonPayee" value="nonPayee" id="non_payee">
            <span class="checkmark"></span>
          </label>
        </div>
    ...
    <table class="w-full sm:bg-white rounded-lg overflow-hidden sm:shadow-lg my-5 text-sm">
        <thead class="text-white">
          <tr class="flex flex-col flex-no-wrap sm:table-row rounded-l-lg sm:rounded-none mb-2 sm:mb-0" style="background: #32e034">
            <th class="p-3 text-left capitalize">Code adhérent</th>
            <th class="p-3 text-left capitalize">Nom</th>
            <th class="p-3 text-left capitalize">Prénom</th>
            <th class="p-3 text-left capitalize">Cotisation</th>
        ...
        <tbody class="flex-1 sm:flex-none">
            ...
            >
              ...
              <td class="border-grey-light border hover:bg-gray-100 p-3 truncate">
                <strong>#{{$finance->user->code_adherent}}</strong>
              </td>
              <td class="border-grey-light border hover:bg-gray-100 p-3 overflow-hidden">
                {{$finance->user->firstname}}
              </td>
              <td class="border-grey-light border hover:bg-gray-100 p-3 overflow-hidden">
                {{$finance->user->lastname}}
              </td>
              <td class="border-grey-light border hover:bg-gray-100 p-3 overflow-hidden">
                {{$finance->cotisation}}
              </td>
              ...
              <td class="border-grey-light border">
                <div class="flex items-center">
                  ...
                  <span>|</span>
                  @endif
                  <a href="/gestion-financiere/{{$finance->id}}"
                    type="button"
                    class="hover:bg-gray-100 p-3 text-green-400 hover:text-yellow-600 hover:font-medium cursor-pointer focus:outline-none capitalize"
                  >
                    Consulter
