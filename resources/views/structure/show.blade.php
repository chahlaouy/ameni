            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        ...
                        <div class="w-full py-3 px-3 bg-white border border-gray-200 rounded shadow-xl">
                            <h3 class="font-bold text-sm ">Date Création</h3>
                        ...
                        <div class="w-full py-3 px-3 bg-white border border-gray-200 rounded shadow-xl">
                            <h3 class="font-bold text-sm ">Numéro Compte Bancaire</h3>
                        ...
                        <div class="w-full py-3 px-3 bg-white border border-gray-200 rounded shadow-xl">
                            <h3 class="font-bold text-sm ">Crée le</h3>
                            <span class="block text-xs text-gray-500">{{$structer->created_at->diffForHumans()}}</span>
                        </div>

                        <div class="w-full py-3 px-3 bg-white border border-gray-200 rounded shadow-xl">
                            <h3 class="font-bold text-sm ">Derniére mise a jour</h3>
